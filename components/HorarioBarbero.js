//HorarioBarbero.js - VERSIÓN CORREGIDA - PRESERVA DATOS EXISTENTES
...
const HorarioBarbero = ({ barberoId, visible, onClose }) => {
  ...
  const fetchHorario = async () => {
    try {
      ...
      if (response.data?.horario) {
        ...
        // ⭐ CORREGIDO: Preservar los datos existentes correctamente
        ...
        console.log('✅ Días laborales normalizados:', diasLaboralesNormalizados); // ⭐ LOG
        ...
        // ⭐ IMPORTANTE: Establecer el estado correctamente
        setHorario({
        ...
        console.log('✅ Estado actualizado correctamente'); // ⭐ LOG
      }
    } catch (error) {
      console.error('❌ Error al obtener horario:', error);
      Alert.alert('Error', 'No se pudo cargar el horario del barbero');
      // ⭐ NO resetear a defaultHorario aquí, mantener el estado actual
    } finally {
      setLoading(false);
    }
  };
  ...
  const saveHorario = async () => {
    try {
      ...
      console.log('💾 Guardando horario...'); // ⭐ LOG
      ...
      console.error('❌ Detalles del error:', error.response?.data); // ⭐ LOG
