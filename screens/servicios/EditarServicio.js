...
const handleUpdate = () => {
  ...
  const styles = StyleSheet.create({
    ...
    labelText: { fontWeight: "500", color: "#00695C" },
    required: { color: "red" },
    input: {
      borderWidth: 1.5,
      borderColor: "#7FFFD4",
    ...
    disabledButton: { backgroundColor: "#B2F0E8" },
    nextButtonText: { color: "#2D2D2D", fontWeight: "500", fontSize: isMobile ? 13 : 14 },
    addButton: {
      padding: isMobile ? 8 : 10,
      borderRadius: 6,
      alignItems: "center",
    ...
    disabledAddButton: { backgroundColor: "#B2F0E8" },
    activeAddButton: { backgroundColor: "#7FFFD4" },
    addButtonText: { color: "#2D2D2D", fontWeight: "500", fontSize: isMobile ? 13 : 14 },
    insumoForm: {
      marginBottom: isMobile ? 14 : 16,
    ...
    backButtonText: { color: "#00695C", fontWeight: "500", fontSize: isMobile ? 13 : 14 },
    submitButton: {
      padding: isMobile ? 8 : 10,
      borderRadius: 6,
      width: "48%",
    ...
    submitButtonText: { color: "#2D2D2D", fontWeight: "500", fontSize: isMobile ? 13 : 14 },
