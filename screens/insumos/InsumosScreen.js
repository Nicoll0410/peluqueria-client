...
const InsumosScreen = ({ navigation }) => {
  ...
  const fetchCategorias = useCallback(async () => {
    try {
      ...
      const { data } = await axios.get(
        'https://peluqueria-server-gw54.onrender.com/categorias-insumos',
  ...
  const fetchInsumos = useCallback(async () => {
    try {
      ...
      const token = await AsyncStorage.getItem('token');
      const { data } = await axios.get(
        'https://peluqueria-server-gw54.onrender.com/insumos/all',
        { headers: { Authorization: `Bearer ${token}` } }
      );
...
useFocusEffect(
  ...
  const handleCreateInsumo = async (newInsumo) => {
    try {
      ...
      const { data } = await axios.post(
        'https://peluqueria-server-gw54.onrender.com/insumos',
        newInsumo,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const verInsumo = async (id) => {
    try {
      const token = await AsyncStorage.getItem('token');
      const { data } = await axios.get(
        `https://peluqueria-server-gw54.onrender.com/insumos/${id}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleUpdateInsumo = async (updatedInsumo) => {
    try {
      ...
      const { data } = await axios.put(
        `https://peluqueria-server-gw54.onrender.com/insumos/${updatedInsumo.id}`,
        updatedInsumo,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const eliminarInsumo = async (id) => {
    try {
      setLoading(true);
      const token = await AsyncStorage.getItem('token');
      await axios.delete(`https://peluqueria-server-gw54.onrender.com/insumos/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
